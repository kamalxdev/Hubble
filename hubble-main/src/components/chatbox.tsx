...
function ChatBox() {
  ...
  return (
    <section className="flex flex-col justify-between ">
      <ChatTopBar />
      <div className="inline-flex flex-col gap-5 bg-zinc-800 w-full py-5 px-10 h-auto overflow-y-scroll">
        {AllChats.map((chat)=>{
...
const ChatTopBar = memo(function ChatTopBar() {
  ...
  return (
    <div className="flex sticky w-full top-0 justify-between items-center bg-slate-200 px-10 py-2 text-black">
      <Link
        href={"/"}
...
const MessageInput = memo(function MessageInput() {
  return (
    <div className="flex sticky bottom-0 justify-between text-black bg-slate-300 shadow-inner px-5 py-2 gap-5">
      <input
        type="text"
...
//   return <div className="bg-slate-900 inline-flex flex-col text-white max-w-md md:max-w-xl p-2 rounded-md" >
